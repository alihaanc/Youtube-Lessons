...
DTCM  float fir_state[LENGTH] = {0.0f};
DTCM  float Fir_Coeff[LENGTH];
FIR_t adc_Filter;
uint32_t mainCountter = 0 ;
...
int main(void)
{
  ...
  MX_RNG_Init();
  /* USER CODE BEGIN 2 */
	fir_Init(&adc_Filter, Fir_Coeff, fir_state, LENGTH);
